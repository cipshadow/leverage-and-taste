---
description: Writing style rules for all markdown and document output
globs: "*.md"
---
...
- **Hedging**: "I think", "perhaps", "maybe" (when you're not actually uncertain)
- **"In order to"**: Say "to"
...
- Prefer active voice ("We will launch" not "Will be launched").
- Don't narrate what you're about to do; just do it.
- 15-25 words per sentence target.

## Quantification
- Use specific numbers over vague qualifiers
- "$450M annually" not "significant revenue"
- "affects 2.3K users" not "many users"
- "30% reduction" not "substantial reduction"
